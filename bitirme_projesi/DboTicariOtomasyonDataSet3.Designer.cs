...
namespace bitirme_projesi.DboTicariOtomasyonDataSet3TableAdapters {
...
SELECT ID, AD, SOYAD, TELEFON, TC, MAIL, IL, ILCE, ADRES, GOREV FROM TBL_PERSONELLER WHERE (ID = @ID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::bitirme_projesi.Properties.Settings.Default.DboTicariOtomasyonConnectionString;
        }
